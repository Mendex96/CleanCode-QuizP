package es.ulpgc.eite.cleancode.quiz.test;
...
public class QuizSteps {
  ...
  public void ocultarResultado() {
    onView(withId(R.id.resultText)).check(matches(not(isDisplayed())));
  ...
  public void pulsarBoton(String b) {
    String tb = activity.getString(R.string.true_label);
  ...
  public void mostrarMensajeWarning() {
    ...
    onView(withId(R.id.confirmationText))
        .check(matches(withText(activity.getString(R.string.confirmation_label))));
  }
